...
public class DBService { 
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cidade c3 = new Cidade(null, "Campintas", est2);

		est1.getCidades().addAll(Arrays.asList(c1));
		est2.getCidades().addAll(Arrays.asList(c2, c3));

		// na hierarquia, salva primeiro os Estados e depois as Cidades
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "marxgentil@hotmail.com", "01652362053", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "24252628"));
		...
		// salva primeiro quem é independente
		...
		// salva primeiro os pedidos que não depende do pagamento e depois o pagamento
		// que depende do pedido
